...
import SearchLesson from './../screens/SearchLesson';
import SelectAddress from './../screens/SelectAddress';
import SelectSavedAddress from './../screens/SelectSavedAddress';
    ...
    return (
        <NavigationContainer>
            ...
            >
                ...
                <Stack.Screen name="SearchLesson" component={SearchLesson} options={{ title: '레슨 목록' }} />
                <Stack.Screen name="SelectAddress" component={SelectAddress} options={{ title: '지역 선택' }} />
                <Stack.Screen name="SelectSavedAddress" component={SelectSavedAddress} options={{ title: '위치 저장' }} />
